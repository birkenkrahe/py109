...
** Review =NumPy= library (DataCamp)
  ...
  5) How many data types can a list have? How many can an array have?
     ...
     : ['me' '1' 'True']
  6) SELECTING array elements bmi > 23, bmi[bmi>23]
  7) 2D arrays
  8) Statistics
...
** TODO Test 7 - NumPy arrays

* 11.3 Wed, 01-Nov

- Solution Tuesday problem (basic calculator with function)
- [[https://app.datacamp.com/workspace/w/d8ac4091-9134-4462-a6b0-57b255987565/edit][Programming exercises]] for =while= ([[https://app.datacamp.com/workspace/w/d8ac4091-9134-4462-a6b0-57b255987565/edit][workspace]])
- "Guess the number" game dissected ([[https://app.datacamp.com/workspace/w/bee3a53b-7c8c-42c4-92f9-1ee55c065e4b/edit][workspace]])
- Continue: =for= loops to repeat a code block a given number of times
- Webscraping tables with =pandas.read_html= (for Ethan and others)
