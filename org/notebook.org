...
** Review DataCamp Python lists - Test 4
...
this in test 4, which will be available tomorrow.
...
2) The =areas= list from DataCamp as a Python dictionary:
   #+begin_src python
     hall = 11.25
     kit = 18.0
     liv = 20.0
...
3) Make a dictionary of class mates =course_dict= with their name as key
...
5) Print ~course_dict~ as a =for= loop!
   #+begin_src python
