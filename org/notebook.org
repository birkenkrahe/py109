...
* Week 15 - Plotting & Test 9

- Finish the function practice [[https://app.datacamp.com/workspace/w/c010d77a-f494-459f-9773-fbfaf67eab6c/edit][notebook]] on your own using the script
  that I distributed in class
- There are more data structures that we did not discuss:
  dictionaries, tuples, sets, and pandas (see DataCamp).
- Plotting practice: histograms, scatterplots, lineplots, and subplots
  ([[file:7_plotting.org][Org]] / [[https://app.datacamp.com/workspace/w/72c934ff-643c-4214-b2ac-e333ed91289d/edit][workspace]])
...
* Week 16 - Test 10 & Project presentations - Final exam

- Project presentations (Dec 4 + Dec 6)
- Final exam (Dec 8)
