...
* DONE Week 15 - Introduction to plotting & Test 9
...
- There are more data structures that we did not discuss:
  dictionaries, tuples, sets, and pandas (see DataCamp lessons).
...
** Project presentations on Dec 13 (Lou: Dec 8)
** Review of Python datastructures ([[https://chat.openai.com/share/249b2dc2-072b-4ae3-a9de-e7b681525382][source]], [[file:8_data_structures.org][org]], [[https://app.datacamp.com/workspace/w/4bdb4827-6bbf-4311-a6b9-9394c07a07c7/edit][workbook]])
...
- Final exam optional unless you want to improve your grade.
- If you're okay with it as it is (at the end of the week) you don't
  have to write the exam (and I won't have to create one).
